...
const theIliad: Translation = {
  slug: 'the-iliad',
  bookSlug: 'the-iliad', // Added for simple blob client
  title: 'the iliad',
  shortDescription:
    'achilles big salty, trojan bros caught in 4k, city going bruh-level meltdown. w drama, 100% based.',
  coverImage:
    'https://82qos1wlxbd4iq1g.public.blob.vercel-storage.com/books/the-iliad/images/the-iliad-01.png',
  status: 'coming-soon',
  ...
  chapters: [
    {
      title: 'book 1',
      text: 'book-01.txt',
      audioSrc: null, // Simplified for now
    },
    {
      title: 'book 2',
      text: 'book-02.txt',
